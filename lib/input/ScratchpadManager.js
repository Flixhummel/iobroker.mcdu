...
class ScratchpadManager {
    ...
    /**
     * Render scratchpad to Line 14 via MQTT
    ...
    async renderError(message) {
        ...
        await this.displayPublisher.publishLine(13, `❌ ${message}`, 'red');
     ...
     * @returns {Promise<void>}
     */
    async renderSuccess(message = '✓ GESPEICHERT') {
